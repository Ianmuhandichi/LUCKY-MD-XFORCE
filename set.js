...
module.exports = { session: process.env.SESSION_ID || 'ezra',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/Ianmuhandichi/LUCKY-MD-XFORCE/tree/main',
    ...
    URL: process.env.URL || "https://files.catbox.moe/fkelmv.jpg",  
    ...
    ANTI_MENTION_GROUP : process.env.ANTI_MENTION_GROUP || "off",
    ANTI_TAG : process.env.ANTI_TAG || "on",
    ANTI_BAD : process.env.ANTI_BAD || "on",
    ANTI_SHARE_GROUP : process.env.ANTI_SHARE_GROUP || "off",
    ANTI_LINK_GROUP : process.env.ANTI_LINK_GROUP || "off",
